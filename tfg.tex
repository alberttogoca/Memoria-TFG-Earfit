...
Una vez establecidas las prioridades del proyecto pasamos a visualizarlas en forma de **Sketches**, **Wireframes** y por último **Prototipos**:
...
Algunas de las cosas que se aprendieron en el continuo proceso de crear, medir, aprender fueron las siguientes:

De los test con el tutor pudimos corregir lo siguiente:

Corregir problemas nombres intervalos e incluir todos los intervalos

Añadir sonido al acertar

De los test con más usuarios pudimos mejorar lo siguiente:

Añadir boton checkall

Ajustar dificultad inicial

Añadir varios instrumentos

Ajustar el volumen

Corregir disponibilidad iphone

De los test A/B lo siguiente:

Añadir piano generaba engagement y retención. A parte en el ejercicio de notas es esencial.

\subsubsection{Resultados}

Una vez pasado por todo este proceso varias veces, el resultado es un MVP que poder sacar al mercado. Y que se debe seguir mejorando. 
