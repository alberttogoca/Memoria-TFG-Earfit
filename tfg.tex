...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.3]{nextjs_routing}
        ...
        \centering
         \subfloat[Sin Pre-rendering]{
          \label{f:nextjs_noprerendering}
           \includegraphics[width=0.4\textwidth]{nextjs_noprerendering}}
         \subfloat[Con Pre-rendering]{
          \label{f:nextjs_prerendering}
           \includegraphics[width=0.4\textwidth]{nextjs_prerendering}}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.2]{nextjs_prerenderinggraph}
    ...
    \begin{figure}[H]
        \centering
         \subfloat[Server-side Rendering]{
          \label{f:nextjs_ssr}
           \includegraphics[width=0.4\textwidth]{nextjs_ssr}}
         \subfloat[Generación Estática]{
          \label{f:nextjs_ssg}
           \includegraphics[width=0.4\textwidth]{nextjs_ssg}}
    ...
    \item Separación automática de código (**Code Splitting**) para cargas de página más rápidas.
        \begin{figure}[H]
            ...
            \includegraphics[width=0.2\textwidth]{nextjs_nocodesplit}}
            \subfloat[Con Code Splitting]{
            \label{f:nextjs_codesplit}
            \includegraphics[width=0.2\textwidth]{nextjs_codesplit}}
    ...
    \item Enrutamiento optimizado con prefetching para Single-page Application: sólo se precargan los elementos mostrados en la página actual.
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.3]{nextjs_prefetch}
    ...
    \item Entorno de desarrollo con soporte **Fast Refresh** y **HMR** (Hot Module Replacement): Permite actualizar todo tipo de módulos y componentes de React en tiempo de ejecución sin necesidad de un refresco completo.
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.3]{nextjs_hmr}
