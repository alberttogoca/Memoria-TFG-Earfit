...
\begin{comment}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.18]{Design Thinking/PrototipoSteps}
        \label{fig:WireframeSteps}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.3]{Design Thinking/Prototipo}
        \label{fig:Wireframe}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.37]{Design Thinking/Prototipo}
        \label{fig:Prototipo}
        \caption{Prototipo Smartphone}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.3]{Design Thinking/PrototipoPC}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3]{Design Thinking/Prototipo/Small/Prototipo}
