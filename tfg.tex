...
\begin{itemize}
    ...
    \item Separación automática de código (**Code Splitting**) para cargas de página más rápidas.
        \begin{figure}[H]
            ...
            \includegraphics[width=0.4\textwidth]{nextjs_nocodesplit_w}}
            \subfloat[Con Code Splitting]{
            \label{f:nextjs_codesplit}
            \includegraphics[width=0.4\textwidth]{nextjs_codesplit_w}}
...
\subsubsection{Coste de las pruebas automáticas}
...
\subsubsection{Objetivos de las pruebas}
