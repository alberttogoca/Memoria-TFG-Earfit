...
\chapter*{Resumen (Redactar mejor)}
...
El entrenamiento auditivo es importante porque la escucha es una habilidad, al igual que tocar el piano. Por ejemplo, las melodías son simplemente series de intervalos. Con el entrenamiento necesario para identificar los intervalos, puedes aprender a tocar una melodía de oído.
...
\section{Necesidad, Hipótesis y Solución}
...
\textbf{¿Cómo gestionamos el desarrollo?}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.48]{Kanban}
    \label{fig:Kanban}
    \caption{Kanban}
\end{figure}
...
\textbf{¿Cómo implementamos la solución?}
