...
Los paquetes de Node o librerías usadas en la implementación son las siguientes:
\begin{itemize}
...
Todas estas librerías se pueden encontrar definidas con sus versiones en el archivo package.json o en la carpeta lib en el caso de soundfont-wrapper.
