...
Este es un ejemplo de como el componente AnswerButtons recibe los datos y Callbacks pertinentes mediante Props, y los utiliza para renderizar los botones de respuesta. Cada vez que se pulse en uno de estos botones, este llamará a ‘handleAnswerButtonClick’ que actualizará el estado que recibe mediante Props. Como el componente recibirá nuevas Props, se actualizará mostrando los cambios.
