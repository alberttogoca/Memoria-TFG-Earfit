...
En este caso se han separado las carpetas por conceptos o intereses, donde cada carpeta contiene archivos similares según la arquitectura:
...
\begin{itemize}
    ...
    \item \textbf{VariantExercise}: En la aplicación se tratan todas las páginas de ejercicio como variantes del mismo. Todas son el mismo ejercicio pero con valores distintos. Lo que nos permite reutilizar toda la lógica como veremos en el hooks. De tal manera que hay tres variantes del ejercicio: ‘notes’, ‘intervals’ y ‘scales’.  
    ...
    \item \textbf{SelectableAnswer}: Añade propiedades por intersección al tipo Answer, necesarias para implementar los botones de selección (AnswerToggles). La propiedad ‘isSelected’ especifica si la respuesta está disponible como pregunta.
    \item \textbf{SelectableAnswerWithColor}: Añade propiedades por intersección al tipo SelectableAnswer, necesarias para implementar los botones de respuesta (AnswerButtons). La propiedad ‘color’ especifica el color que debe tomar el botón de respuesta.
...
Estos son los Custom Hooks desarrollados para la aplicación, cada uno cubre un caso de uso específico. Se puede encontrar una relación entre el nombre de los Hooks y de los componentes a los que dan funcionalidad, por lo que se puede asociar fácilmente cada uno.
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{Reactjs/ReactComponent}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{Detalles de Implementación/Code/Pages/Intervals}
    \label{fig:Intervals}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{Detalles de Implementación/Code/Components/AnswerButtons}
