...
\begin{itemize}
    ...
    \end{itemize}
        ...
        \item Separación automática de código (**Code Spliting**) para cargas de página más rápidas.
    \item Enrutamiento optimizado con prefetching para **Single-page Application:** sólo se precargan los elementos mostrados en la página actual.
    ...
    \item **Rutas API** para crear endpoints con funciones sin servidor: Cualquier archivo dentro de la carpeta pages/api se asigna a /api/* y se tratará como un endpoint en lugar de una página.
    \item Soporte para **TypeScript**. (completar)
\end{itemize}
...
Es una biblioteca de código abierto para proyectos de JavaScript, que permite a los desarrolladores crear aplicaciones web e interfaces de usuario mantenida por Facebook. 
...
Es una plataforma en la nube que permite a los desarrolladores alojar sitios web y servicios web que escalan automáticamente y no requieren supervisión.
